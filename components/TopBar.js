	...
	return (
		<>
			<Flex
				...
				gap='5'
			>
				<Box marginInlineStart='0.5em' display={['block', 'block', 'none', 'none', ' none']}>
					<IconButton
				...
				{role === 'ADMIN' ? (
					<>
						<Link as={NextLink} href='/loan' display={['none', 'none', 'block', 'block', ' block']}>
							Varaukset
						</Link>
						<Link as={NextLink} href='/admin' display={['none', 'none', 'block', 'block', ' block']}>
							Hallinta
						</Link>
					</>
				) : null}
				<Link as={NextLink} href='/account' display={['none', 'none', 'block', 'block', ' block']}>
					Oma tili
				</Link>
