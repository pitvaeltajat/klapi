    ...
    return (
        <div>
            <AlertDialog isOpen={isOpen} leastDestructiveRef={cancelRef} onClose={onClose}>
                <AlertDialogOverlay>
                    <AlertDialogContent>
                        ...
                        <AlertDialogBody>
                            Oletko täysin varma? Systeemi voi mennä ihan vitun solmuun, jos tiedot
                            ei ole kunnolla tarkistettuja.{' '}
                        </AlertDialogBody>
            ...
            <Stack direction="row">
                <Input
                    borderColor={
                        endDate != loan.endTime.toString().split('.')[0] ? 'orange.200' : 'gray.300'
                    }
