...
export default function EditItem({ item, categories }: { item: ItemWithRelations; categories: Category[] }) {
          ...
          Muokkaa kamaa
				...
				<FormControl>
					...
					{image !== null ? (
						...
						<Image src={item.image} alt={item.name} maxW='full' maxH='400px' objectFit='contain' mb={4} />
					) : null}
