        ...
        {(props) => (
          <Form onSubmit={props.handleSubmit}>
            ...
            <Field name="categories">
              {({ field, form }) => (
                <FormControl
                  isInvalid={form.errors.categories && form.touched.categories}
                >
            ...
            <Field name="locationId">
              {({ field, form }) => (
                <FormControl
                  isInvalid={form.errors.locationId && form.touched.locationId}
                  isRequired
                >
                  ...
                  <CreatableSelect
                    ...
                    isClearable
                  />
                  <FormErrorMessage>{form.errors.locationId}</FormErrorMessage>
                </FormControl>
              )}
            </Field>
            <Button
