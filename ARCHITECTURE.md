...
| `/kiosk/startloan` | kiosk pickup queue (the kamat are edited on the card itself, with the same `components/LoanItemsEditor.tsx` rows + picker as `/loan/[id]/edit`, oma kama included) |
