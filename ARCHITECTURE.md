...
| `/kiosk/startloan` | kiosk pickup queue ("Muokkaa kamoja" edits the kamat with the same `components/LoanItemsEditor.tsx` rows + picker as `/loan/[id]/edit`, oma kama included) |
